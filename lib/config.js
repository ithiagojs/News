...
// Aumentado para 3000 para evitar múltiplos anúncios do CallMeBot e reduzir rate limiting.
export const WHATSAPP_MAX_LENGTH = Number(process.env.WHATSAPP_MAX_LENGTH || 3000);
