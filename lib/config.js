...
// Alimenta a IA com variedade; ela escolhe os 2 melhores por seção.
...
export const BRIEFING_ITEMS_PER_SECTION = 2;

// Limite de caracteres da mensagem WhatsApp (CallMeBot GET URL constraint).
export const WHATSAPP_MAX_LENGTH = 1600;
