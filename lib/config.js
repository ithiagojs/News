...
// Reduzido para 600 para evitar que o CallMeBot trunque a mensagem (limite de ~1000 caracteres codificados na URL).
export const WHATSAPP_MAX_LENGTH = Number(process.env.WHATSAPP_MAX_LENGTH || 600);
