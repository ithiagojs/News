...
export async function enrichWithGroq(date, collected) {
  ...
  const prompt = {
    ...
    rules: [
      ...
      'Devolva todas as secoes recebidas e todos os itens recebidos em cada secao; nao reduza a quantidade de topicos.',
      'Se houver 5 itens em Brasil ou Mundo, devolva os 5. Se houver 3 em economia, devolva os 3. Se houver 4 em tecnologia, devolva os 4.',
      'Use apenas os itens fornecidos, sem inventar fatos.',
      'A manchete do dia deve ter titulo e resumo de 2 a 5 linhas.',
      'Brasil e Mundo: 3 a 5 topicos cada quando houver material.',
      'Economia/mercados: ate 3 topicos.',
      'Tecnologia/ciencia/cultura: ate 4 topicos.',
